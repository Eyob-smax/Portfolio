...
const SkillCard: React.FC<SkillCardProps> = ({ icon: Icon, title, level }) => (
  <div className="flex flex-1 flex-col gap-3 rounded-2xl border border-[#d4e2e1] bg-[#f9fbfb] p-5 shadow-sm hover:shadow-md transition-shadow">
...
const TechPortfolio: React.FC = () => {
  return (
    <div
      className="flex h-auto min-h-screen w-full flex-col overflow-x-hidden"
      style={{ fontFamily: '"Spline Sans", "Noto Sans", sans-serif' }}
    >
      <main className="py-12 mt-10 gap-8 mx-auto w-[78%] flex flex-col">
        <section>
          <h1 className="text-3xl text-center font-bold text-[#101817] mb-6">
            Tech Stack & Tools
          </h1>
